...
#df.to_csv('./crawl_twse_stockid_2.csv', sep=',', encoding='utf-8-sig', index=False)
...
df_final.to_csv('./csv/' + dt_day + '_crawl_twse_stockid_2.csv', sep=',', encoding='utf-8-sig', index=False)
